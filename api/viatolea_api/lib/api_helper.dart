...
String parameterToString(dynamic value) {
  ...
  if (value is GlutenAmount) {
    return GlutenAmountTypeTransformer().encode(value).toString();
  }
  if (value is IngredientToleranceRating) {
    return IngredientToleranceRatingTypeTransformer().encode(value).toString();
  }
  if (value is IntoleranceTreatment) {
    return IntoleranceTreatmentTypeTransformer().encode(value).toString();
  }
  if (value is Phase) {
    return PhaseTypeTransformer().encode(value).toString();
  }
